...
//   - providers/codex/plugins/antom/skills/<skill>/...
//
// Usage:
...
// Codex bundles every skill under a single "antom" plugin, mirroring the
// claude/cursor layout (one plugin, multiple skills).
const CODEX_SKILLS_DIR = path.join(
  repoRoot,
  "providers/codex/plugins/antom/skills",
);
...
const run = async () => {
  ...
  for (const skill of skillNames) {
    ...
    const targets = [
      ...
      // Codex layout: providers/codex/plugins/antom/skills/<skill>/
